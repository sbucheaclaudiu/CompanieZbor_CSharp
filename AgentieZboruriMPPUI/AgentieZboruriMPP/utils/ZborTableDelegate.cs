...
{
    public class ZborTableDelegate : NSTableViewDelegate
    {
        private const string CellIdentifier = "ZborCell";
        
        private readonly ZborTableDataSource DataSource;
        public ZborTableDelegate(ZborTableDataSource datasource)
        {
